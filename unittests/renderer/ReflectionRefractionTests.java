...
public class ReflectionRefractionTests {
    ...
    public void twoSpheres() {
        ...
        scene._geometries.add( //
                new Sphere(new Point(0, 0, -50), 50d).setEmission(new Color(BLUE)) //
                        ...
                        .setMaterial(new Material().setkD(0.5).setkS(new Double3(0.5)).setShininess(100)));
        scene._lights.add( //
    ...
    public void trianglesTransparentSphere() {
        ...
        scene2._geometries.add( //
                ...
                new Triangle(new Point(-150, -150, -115), new Point(-70, 70, -140), new Point(75, 75, -150)) //
                        .setMaterial(new Material().setkD(0.5).setkS(0.5).setShininess(60)).setEmission(Color.ORANGE), //
    ...
    public void ourOwnTest(){
        ...
        scene._geometries.add( //
                new Sphere(new Point(0, 0, -50), 50d).setEmission(new Color(BLUE)) //
                        .setMaterial(new Material().setkD(0.4).setkS(0.5).setShininess(100).setkT(new Double3(0.5))
                        ), new Sphere(new Point(0, 0, -50), 25d).setEmission(new Color(RED)) //
                        .setMaterial(new Material().setkD(0.5).setkS(new Double3(0.5)).setShininess(100)));


        camera.setImageWriter(new ImageWriter("ourOwnTest", 500, 500)) //
                .setRayTracer(new RayTracerBasic(scene)) //
                .renderImage() //
                .writeToImage();
